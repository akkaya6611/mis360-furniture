    ...
    <div class="emdief-container">
        ...
        <div class="footer-grid">
            ...
            <div class="footer-col">
                ...
                <h3 class="footer-heading"><?php esc_html_e('Montessori Ürünleri', 'mis360-mobilya'); ?></h3>
            ...
            <div class="footer-col">
                ...
                <h3 class="footer-heading"><?php esc_html_e('Müşteri & Kurumsal', 'mis360-mobilya'); ?></h3>
            ...
            <div class="footer-col footer-contact-col">
                ...
                <h3 class="footer-heading"><?php esc_html_e('Bize Ulaşın', 'mis360-mobilya'); ?></h3>
